...
const ContactUs = () => {
  return (
    <section className="font-Untitled-Sans">
      <div
        className="relative bg-cover bg-fixed bg-center w-full overflow-hidden h-full"
        style={{ backgroundImage: `url('${contactHeaderBg}')` }}
      >
        <div className="w-full h-full bg-[#00000060] backdrop-blur-sm relative text-center z-[8] flex flex-col items-center p-28 justify-center">
          <h1
            data-aos="fade-right"
      ...
      <section className="md:p-20  bg-white">
        <h3
        ...
        <div className="flex gap-14 h-fit justify-between overflow-hidden md:flex-row flex-col items-center">
          <div
            ...
            data-aos-offset="200"
            className="border-l-[1px]  bg-[#a09f9f17] border-zinc-500 md:p-8"
          >
          ...
          <div data-aos="zoom-out" data-aos-animation-duration="5000">
            <img src={customerSupport} alt="" className="max-w-[450px]" />
          </div>
        </div>

        <div className="flex h-fit gap-14 justify-between overflow-hidden md:flex-row flex-col items-center">
          <div data-aos="zoom-out" data-aos-animation-duration="5000">
            <img src={salesInquiry} alt="" className="max-w-[400px]" />
          </div>
          ...
          <div
            ...
            data-aos-animation-duration="5000"
            data-aos-offset="200"
            className="border-r-[1px] text-right bg-[#a09f9f17] border-zinc-500 md:p-8"
          >
            <h4 className="text-xl text-zinc-800 font-medium">
              Sales Inquiries
            </h4>
      ...
      >
        ...
        >
          ...
          <div className="mt-6 flex flex-col  items-center gap-4">
            <li
              data-aos="zoom-in"
              className="flex gap-2 items-center font-[500]"
            >
              <FaLocationDot className="text-xl" /> KeyWizards Headquarters 1234
            ...
            <li
              ...
              className="flex gap-2 items-center font-[500]"
            >
              <GoClockFill /> Monday to Friday, 10 AM - 4 PM (EST)
            </li>
          </div>
        </div>
      </section>

      <section className="md:p-20 gap-14 grid md:grid-cols-2 grid-cols-1">
        <div>
          <img src={FAQs} alt="" />
        </div>
      ...
      <section className="md:p-20 p-8  bg-white">
        ...
        <div className="flex justify-between gap-14 mb-6">
          ...
          <ul className="flex mt-6 justify-between gap-4">
            <li>
              <a
                href="https://www.facebook.com/"
                className="border-[1px] w-12 box-content rounded-full p-2 bg-white transition-all duration-500 flex items-center ease-in-out hover:w-52 overflow-hidden group"
              >
                <img
                  ...
                  className="w-12"
                />
                <p className="opacity-0 cursor-pointer text-blue-700 px-2 transition-opacity duration-500 delay-300 hover:underline underline-offset-2 group-hover:opacity-100 font-medium">
                  fb.com/keywizards
                </p>
              </a>
            </li>
            <li>
              <a
                ...
                className="border-[1px] w-12 box-content rounded-full p-2 bg-white transition-all duration-500 flex items-center ease-in-out hover:w-40 overflow-hidden group"
              >
                <img src={instagram} alt="" className="w-12" />
                <p className="opacity-0 cursor-pointer text-pink-700 px-2 transition-opacity duration-500 delay-300 hover:underline underline-offset-2 group-hover:opacity-100 font-medium">
                  @keywizards
                </p>
              </a>
            </li>
            <li>
              ...
              >
                ...
                <p className="opacity-0 cursor-pointer text-zinc-700 px-2 transition-opacity duration-500 delay-300 hover:underline underline-offset-2 group-hover:opacity-100 font-medium">
                  @keywizards
                </p>
              </a>
            </li>
        ...
        <p className="text-zinc-500 text-xl mb-6 font-semibold">Or</p>
      ...
      >
        ...
        >
            ...
            <p
              ...
              className="text-zinc-100 mt-2 my-4 max-w-[700px] selection:bg-[#ffffff66] "
            >
              Your feedback is invaluable to us. Whether it’s a suggestion to improve our products or a comment on your experience with KeyWizards, we want to hear from you. Share your thoughts by emailing us at feedback@keywizards.com.
            </p>
        </div>
      </section>
      ...
      <section className="md:p-20 p-8 text-center">
        ...
        <p className="w-[400px] mx-auto mb-8 text-zinc-500">
        ...
        <form
          ...
          className="border-[1px] gap-6 grid grid-cols-2 bg-white border-zinc-300 p-8 rounded-md"
        >
          {/* input */}
