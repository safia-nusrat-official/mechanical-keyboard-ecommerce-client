...
const whyChooseSection = () => {
  return (
    <section className="md:px-20 p-8">
        <div className="section-video-bg-container h-[200px] md:h-[140px] flex justify-center items-center overflow-hidden relative">
          <video
            autoPlay
            loop
            muted
          ...
          <div className="overlay top-4 relative font-[600] text-4xl md:mt-0  md:text-6xl mb-6 text-center mix-blend-screen z-[4] text-black ">
            <h2 data-aos-delay="500" className="md:p-8 pb-10 bg-[#fefefe]">
        ...
        <div className="flex mt-6 items-start md:flex-row flex-col gap-2">
          {whyChooseSectionData.slice(0, 3).map((data, index) => (
            <div className="flex relative items-center">
              <div
                className={`h-28 w-[1.5px] bg-zinc-700 ${index === 0 ? "hidden" : "block"} mx-4`}
              ></div>
